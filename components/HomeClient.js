      ...
      >
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto">
          ...
          >
            Where Art
            <br />
            <span className="text-charcoal/40 font-light italic">Meets Devotion</span>
          </motion.h1>
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 scroll-indicator">
          <div className="flex flex-col items-center gap-2 opacity-40">
            <span className="text-[9px] tracking-[0.25em] uppercase text-warm-gray">Scroll</span>
        ...
        <div className="max-w-7xl mx-auto">
          <AnimatedSection className="text-center mb-16">
            <div className="inline-flex items-center gap-3 mb-4">
              ...
              <span className="text-[10px] font-semibold tracking-[0.3em] uppercase text-maroon/60">Gallery</span>
              <div className="w-6 h-[1px] bg-maroon/30" />
            </div>
      ...
      >
        ...
        <div className="max-w-5xl mx-auto">
          <AnimatedSection className="text-center">
            <div className="inline-flex items-center gap-3 mb-4">
              <div className="w-6 h-[1px] bg-maroon/30" />
              <span className="text-[10px] font-semibold tracking-[0.3em] uppercase text-maroon/60">Our Story</span>
              <div className="w-6 h-[1px] bg-maroon/30" />
            </div>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground tracking-tight">
              A Family Art House
            ...
            <AnimatedSection delay={0.1} direction="left">
              <div className="relative aspect-[4/5] rounded-sm overflow-hidden artwork-image-container group">
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  ...
                  <p className="text-[10px] text-white/50 tracking-[0.2em] uppercase mt-1">Contemporary Calligraphy</p>
                </div>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.2} direction="right">
              <div className="relative aspect-[4/5] rounded-sm overflow-hidden artwork-image-container group">
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  ...
                  <p className="text-[10px] text-white/50 tracking-[0.2em] uppercase mt-1">Landscape Painting</p>
                </div>
              </div>
            </AnimatedSection>
          </div>
