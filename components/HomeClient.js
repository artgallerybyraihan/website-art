...
export default function HomeClient({ featuredArtworks }) {
  ...
  return (
    <>
      {/* ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ HERO ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      <section
      ...
      >
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto">
          ...
          >
            ...
            landscape paintings ΓÇö handmade in Indonesia, curated for the
      ...
      {/* ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ FEATURED ARTWORKS ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      <section className="py-24 lg:py-32 px-6" id="featured-artworks">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="columns-1 sm:columns-2 lg:columns-4 gap-8 lg:gap-6 space-y-8 lg:space-y-0">
      ...
      {/* ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ BRAND STORY ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      <section
      ...
      {/* ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ WHATSAPP CTA BANNER ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      <section className="py-24 lg:py-32 px-6 bg-charcoal" id="cta-banner">
        <AnimatedSection className="max-w-2xl mx-auto text-center">
          ...
          <p className="mt-4 text-sm text-white/50 leading-relaxed max-w-md mx-auto">
            Every artwork is one of a kind ΓÇö reach out to discuss a piece that
            speaks to you.
          </p>
          <div className="mt-10">
            <a
